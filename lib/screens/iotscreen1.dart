...
class IotScreen1 extends StatefulWidget {
  @override
  IotScreen1State createState() => IotScreen1State();
}

class IotScreen1State extends State<IotScreen1>
    with AutomaticKeepAliveClientMixin {
  SfRangeValues tempRange = SfRangeValues(30.0, 38.0);
  SfRangeValues humidityRange = SfRangeValues(50.0, 69.0);
  SfRangeValues pressureRange = SfRangeValues(1.1, 1.3);
